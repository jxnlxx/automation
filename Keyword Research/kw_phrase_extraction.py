...
kw_input = pd.read_csv( fr'L:\Commercial\Operations\Technical SEO\Automation\Keyword Research\01_sample_keywords.csv' )
...
top_phrases.to_csv(r'L:\Commercial\Operations\Technical SEO\Automation\Keyword Research\02_kw_phrase_extraction_output.csv', index=False )
