# -*- coding: utf-8 -*-
"""
@author: Jie Jenn, DataSolveProblems
https://gist.github.com/DataSolveProblems/b49f9fef1281a8f32d23e62c5d501eb0#file-google-py
"""
...
site = 'https://www.betvictor.com'                                             # Property to extract
num_days = 5                                                                   # Number of Days, Months to Extract
creds = r'C:\Users\JLee35\OneDrive - Dentsu Aegis Network\CURRENT PROJECTS\Python\APIs\keys\iprospectseonorth\OAuth2\credentials.json'   # Credential file from GSC
output = 'gsc_data.csv'
...
def authorize_creds(creds):
    ...
    storage = file.Storage(r'C:\Users\JLee35\OneDrive - Dentsu Aegis Network\CURRENT PROJECTS\Python\APIs\keys\iprospectseonorth\OAuth2\webmaster_credentials.dat')
