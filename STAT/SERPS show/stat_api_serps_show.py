...
# # formula for inverse rank
# not_ranking = 120
# inverse_rank = (not_ranking + 1) - rank
...
url = f'{stat_base_url}/serps/show?keyword_id={kw_id}&engine=google&date={date}&format=json'
...
kw_df.to_csv( r'C:\Users\JLee35\Automation\STAT\SERPs Show\stat_api_serps_show.csv', index = False)
